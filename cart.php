...
<body>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="cartsystem.php">Checkout</a>
      </li>
	   <li class="nav-item">
				...
				<table class="table table-bodered table-striped text-center">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="action.php?remove=<?= $row['id']?>" class="text-danger lead" onclick="return confirm('Are you sure you dont want that?');"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					...
					<tr>
						<td colspan="3">
							<a href="cartsystem.php" class="btn btn-success"><i class="fa fa-cart-plus"></i>&nbsp;&nbsp; Continue Shopping</a>
						</td>
